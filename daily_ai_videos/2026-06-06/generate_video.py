"""
Daily AI Video Generator — June 6, 2026
Topic  : 5 FREE AI Tools Making People $500/Day in 2026
Niche  : AI Tools × Make Money Online ($15–20 CPM, peak search volume)
New    : scripthook — **keyword** markers → yellow captions + hl slide chips
Thumb  : Generated via Canva API (see title_description_hashtags.txt for link)
"""
...
SOURCES = [
    "outlierkit.com  — Most profitable YT niches",
    "nexlev.io       — Fastest-growing faceless niches",
    "miraflow.ai     — Best Shorts niches by RPM",
    "tubebuddy.com   — Top Shorts niches 2026",
]
TOOLS = [
    "claude.ai          — Anthropic (free tier)",
    "canva.com/ai       — AI design generation",
    "elevenlabs.io      — Voice cloning platform",
...
SEGMENTS = [
    (
        "TODAY",
        "These **5 AI tools** are making people **$500 a day** right now — "
    ...
    (
        "#1 CLAUDE",
        "Number one: **Claude by Anthropic**. Use it to write **AI automation scripts**, "
        "build **micro-SaaS tools**, or create done-for-you workflows for local businesses. "
        "Freelancers are charging **$500 per project** for work Claude drafts in under ten minutes.",
        [
            ("#1  CLAUDE", "lg"),
            ("by Anthropic", "sm"),
            ("", "gap"),
            ("AI automation scripts", "md"),
            ("Micro-SaaS · done-for-you", "sm"),
            ("", "gap"),
            ("$500 per project", "hl"),
            ("drafted in 10 minutes", "sm"),
        ],
        (150, 100, 255),
    ),
    (
        "#2 CANVA AI",
        "Number two: **Canva AI**. With **Magic Design** and **bulk create**, "
        "you can generate hundreds of templates at once and sell them on Etsy or Creative Market. "
        "Top sellers pull **$2,000 a month** from Canva template packs alone.",
        [
            ("#2  CANVA AI", "lg"),
            ("Magic Design · Bulk Create", "sm"),
            ("", "gap"),
            ("100s of templates", "md"),
            ("Sell on Etsy · Creative Market", "sm"),
            ("", "gap"),
            ("$2,000/month", "hl"),
            ("from template packs", "sm"),
        ],
        (100, 200, 80),
    ),
    (
        "#3 ELEVENLABS",
        "Number three: **ElevenLabs**. Clone any voice, narrate **audiobooks**, "
        "and sell the service as a **freelancer**. "
        "Voice-over artists using ElevenLabs bill **$80 to $150 an hour** for AI-generated audio.",
        [
            ("#3  ELEVENLABS", "lg"),
            ("Voice cloning · Audiobooks", "sm"),
            ("", "gap"),
            ("Sell as a freelancer", "md"),
            ("AI-generated voice-over", "sm"),
            ("", "gap"),
            ("$80–$150/hour", "hl"),
            ("billed to clients", "sm"),
        ],
        (255, 120, 50),
    ),
    (
        "#4 SUNO AI",
        "Number four: **Suno AI**. It generates full songs from a text prompt. "
        "People license AI music for **YouTube videos**, **ads**, and **podcasts**. "
        "Some creators pull **$300 to $800 a month** in music royalties alone.",
        [
            ("#4  SUNO AI", "lg"),
            ("Full songs from text prompt", "sm"),
            ("", "gap"),
            ("License for YT · Ads · Pods", "md"),
            ("", "gap"),
            ("$300–$800/month", "hl"),
            ("in music royalties", "sm"),
        ],
        (255, 70, 130),
    ),
    (
        "#5 PERPLEXITY",
        "And number five: **Perplexity**. "
        "A deep research engine that replaces **hours of Googling**. "
        "Sell **research reports** to small businesses, "
        "or build niche content sites paying **$15 to $30 per thousand views**.",
        [
            ("#5  PERPLEXITY", "lg"),
            ("Deep research engine", "sm"),
            ("", "gap"),
            ("Sell research reports", "md"),
            ("Build niche content sites", "sm"),
            ("", "gap"),
            ("$15–$30 per 1K views", "hl"),
            ("in high-CPM niches", "sm"),
        ],
        (40, 190, 255),
    ),
    (
        ...
        "and exactly how to make money with it.",
        [
            ("Follow now.", "xl"),
            ("", "gap"),
            ("Daily: 1 tool · 1 niche", "md"),
            ("exactly how to make", "md"),
            ("money with it.", "md"),
            ("", "gap"),
